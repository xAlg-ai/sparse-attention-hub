...
class OpenEvolveMasker(ResearchMasker):
    ...
    def add_mask(
        ...
        **kwargs: Dict[str, Any],
        ...
        # (1) Deterministic top-k: minimal number of keys covering ≥97% exp(attn) mass
        ...
        # Safety: at least 1, at most 10 or (len//10 + 1)
        ...
        # (2) Aggressive statistical tail: shrink budget and cap further
        rel_mass_covered = cumsum[..., -1:] / (static_denominator + 1e-8)
        # Shrink tail sampling if ≥97% mass covered, else allow a bit more
        ...
        # Ultra strict max: 5% of sampling range
        ...
        # ------------------------------------------------------------------ #
        # Merge previous mask, top-mass, and adaptive tail
        # ------------------------------------------------------------------ #
