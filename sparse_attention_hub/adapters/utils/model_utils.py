...
def generate_model_key(model_name: str, gpu_id: Optional[int], model_kwargs: Dict[str, Any]) -> str:
...
def generate_tokenizer_key(tokenizer_name: str, tokenizer_kwargs: Dict[str, Any]) -> str:
