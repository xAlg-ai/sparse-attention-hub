...
class ModelCreationError(ModelServerError):
    ...
    def __init__(self, model_name: str, gpu_id: int = None, original_error: Exception = None) -> None:
...
class ResourceCleanupError(ModelServerError):
    ...
    def __init__(self, resource_key: str, resource_type: str, original_error: Exception = None) -> None:
