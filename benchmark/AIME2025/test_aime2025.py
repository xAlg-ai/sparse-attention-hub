...
def test_metrics_calculation():
    ...
    print(f"\nValidation:")
    print(f"✓ Exact match: {metrics['exact_match']:.3f} (expected: {expected_exact_match:.3f})")
    print(f"✓ Extraction rate: {metrics['extraction_rate']:.3f} (expected: {expected_extraction_rate:.3f})")
    print(f"✓ Boxed format rate: {metrics['boxed_format_rate']:.3f} (expected: {expected_boxed_rate:.3f})")
...
def main():
    ...
    print("  python evaluation/evaluate.py --dataset aime2025 --base_model <model_name>")
