...
class OptimizedBenchmarkExecutor(BenchmarkExecutor):
    ...
    def _run_optimization_phase(
        ...
        configs_to_optimize = [
            ...
            if name != "dense" and name != "streaming_conservative"  # Skip only dense and fixed configs
        ]
...
def run_optimized_benchmarks(
    ...
    Args:
        ...
        request_kwargs: Additional keyword arguments for benchmark requests (e.g., max_requests)
    """
