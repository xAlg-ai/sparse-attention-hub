...
weight_file = (
    "/workspace/HashAttention-1.0/artifacts/llama3.1-8b-patch.64K.v1.hat_weights.pkl"
)
...
SPARSE_CONFIGS.append(
    (
        get_random_sampling_config_name(0.02, 0.02, 0.01),
        ResearchAttentionConfig(
            masker_configs=[
...
SPARSE_CONFIGS.append(
    (
        get_adaptive_config_name(0.001, 0.001, 0.02, 0.01, 0.1, 0.1),
        ResearchAttentionConfig(
            masker_configs=[
...
SPARSE_CONFIGS.append(
    (
        get_hashattention_config_name(0.005, 0.005, 0.04),
        ResearchAttentionConfig(
            masker_configs=[
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_p_config_name(0.001, 0.001, 0.75),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_k_config_name(0.005, 0.005, 0.04),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.005),
                LocalMaskerConfig(window_size=0.005),
...
SPARSE_CONFIGS.append(
    (
        get_random_sampling_config_name(0.001, 0.001, 0.1),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_adaptive_config_name(0.001, 0.001, 0.05, 0.05, 0.25, 0.25),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_adaptive_hat_config_name(0.001, 0.001, 0.05, 0.05, 0.4, 0.4),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_hashattention_config_name(0.001, 0.001, 0.09),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_p_config_name(0.02, 0.02, 0.8),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.02),
                LocalMaskerConfig(window_size=0.02),
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_k_config_name(0.001, 0.001, 0.04),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.001),
                LocalMaskerConfig(window_size=0.001),
...
SPARSE_CONFIGS.append(
    (
        get_random_sampling_config_name(0.02, 0.02, 0.2),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.02),
                LocalMaskerConfig(window_size=0.02),
...
SPARSE_CONFIGS.append(
    (
        get_adaptive_config_name(0.02, 0.02, 0.05, 0.1, 0.3, 0.3),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.02),
                LocalMaskerConfig(window_size=0.02),
...
SPARSE_CONFIGS.append(
    (
        get_adaptive_hat_config_name(0.005, 0.005, 0.1, 0.1, 0.25, 0.25),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.005),
                LocalMaskerConfig(window_size=0.005),
...
SPARSE_CONFIGS.append(
    (
        get_hashattention_config_name(0.005, 0.005, 0.19),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.005),
                LocalMaskerConfig(window_size=0.005),
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_p_config_name(0.01, 0.01, 0.95),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.01),
                LocalMaskerConfig(window_size=0.01),
...
SPARSE_CONFIGS.append(
    (
        get_oracle_top_k_config_name(0.005, 0.005, 0.19),
        ResearchAttentionConfig(
            masker_configs=[
                SinkMaskerConfig(sink_size=0.005),
                LocalMaskerConfig(window_size=0.005),
