...
:license: Apache 2.0
:date: 2025-01-27
:summary: Tests for DoubleSparsityTopKMasker utility functions.
"""
...
class TestDoubleSparsityUtils:
    ...
    def test_load_sorted_channels_from_file_invalid_structure(self):
        ...
        try:
            with pytest.raises(ValueError, match="Channel file must contain a JSON object"):
                load_sorted_channels_from_file(temp_file)
        finally:
            Path(temp_file).unlink()
    ...
    def test_load_sorted_channels_from_file_invalid_channel_data(self):
        ...
        test_data = {
            "model.layers.0.self_attn.k_proj": "not_a_list"
        }
        ...
        try:
            with pytest.raises(ValueError, match="Channel data for model.layers.0.self_attn.k_proj must be a list"):
                load_sorted_channels_from_file(temp_file)
        finally:
            Path(temp_file).unlink()
    ...
    def test_load_sorted_channels_from_file_invalid_channel_indices(self):
        ...
        test_data = {
            "model.layers.0.self_attn.k_proj": [["not", "integers"]]
        }
        ...
        try:
            with pytest.raises(ValueError, match="Channel indices for model.layers.0.self_attn.k_proj\\[0\\] must be integers"):
                load_sorted_channels_from_file(temp_file)
        finally:
            Path(temp_file).unlink()
    ...
    def test_extract_layer_channels_nonexistent_layer(self):
        ...
        with pytest.raises(ValueError, match="No sorted channels found for model.layers.1.self_attn.k_proj"):
    ...
    def test_extract_layer_channels_nonexistent_projection(self):
        ...
        with pytest.raises(ValueError, match="No sorted channels found for model.layers.0.self_attn.q_proj"):
    ...
    def test_extract_layer_channels_empty_data(self):
        ...
        with pytest.raises(ValueError, match="Empty channel data for model.layers.0.self_attn.k_proj"):
    ...
    def test_validate_channel_data_mixed_valid_invalid(self):
        ...
        with pytest.raises(ValueError, match="Channel data for model.layers.0.self_attn.q_proj must be a list"):
    ...
    def test_edge_cases(self):
        ...
        single_channel_data = {
            "model.layers.0.self_attn.k_proj": [[0]]
        }
