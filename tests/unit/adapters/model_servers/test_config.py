...
class TestModelServerConfig:
    ...
    def test_config_equality(self) -> None:
        ...
        config1 = ModelServerConfig(
            delete_on_zero_reference=True, enable_stats_logging=True
        )
        config2 = ModelServerConfig(
            delete_on_zero_reference=True, enable_stats_logging=True
        )
        config3 = ModelServerConfig(
            delete_on_zero_reference=False, enable_stats_logging=True
        )
