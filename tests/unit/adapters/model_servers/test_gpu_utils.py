...
class TestGPUUtils:
    ...
    def test_cleanup_gpu_memory_no_gpu_id(
    ...
    @patch("sparse_attention_hub.adapters.utils.gpu_utils.torch.cuda.empty_cache")
    def test_cleanup_gpu_memory_with_gpu_id(
        self, mock_empty_cache, mock_device, mock_is_available
    ) -> None:
    ...
    @patch("sparse_attention_hub.adapters.utils.gpu_utils.torch.cuda.device")
    @patch("sparse_attention_hub.adapters.utils.gpu_utils.torch.cuda.empty_cache")
    def test_cleanup_gpu_memory_with_exception(
        self, mock_empty_cache, mock_device, mock_is_available
    ) -> None:
